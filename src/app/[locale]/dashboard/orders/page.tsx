...
export default function OrdersPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-n2f-text mb-6">{t("orders")}</h1>
      ...
      <div className="bg-n2f-secondary border border-n2f-border rounded-xl p-8 text-center">
        ...
        <h2 className="text-lg font-semibold text-n2f-text mb-2">{t("noOrders")}</h2>
        <p className="text-sm text-n2f-text-muted mb-6">{t("noOrdersDesc")}</p>
        <Link
          href="/shop"
