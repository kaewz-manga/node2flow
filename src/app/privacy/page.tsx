  ...
  return (
    <main className="relative overflow-hidden pt-[calc(80px+60px)] pb-20 bg-n2f">
      <div className="w-full max-w-[800px] mx-auto px-6">
        <h1 className="text-4xl max-md:text-[28px] font-extrabold text-white mb-8">Privacy Policy</h1>
        <p className="text-sm text-n2f-text-dim mb-8">อัพเดทล่าสุด: มกราคม 2026</p>

        <div className="space-y-8">
          <section>
            <h2 className="text-xl font-extrabold text-n2f-accent mb-3">1. ข้อมูลที่เราเก็บรวบรวม</h2>
          ...
          <section>
            <h2 className="text-xl font-extrabold text-n2f-accent mb-3">2. วิธีการใช้ข้อมูล</h2>
            <p className="text-n2f-text-secondary leading-[1.8]">
          ...
          <section>
            <h2 className="text-xl font-extrabold text-n2f-accent mb-3">3. การรักษาความปลอดภัย</h2>
            <p className="text-n2f-text-secondary leading-[1.8]">
          ...
          <section>
            <h2 className="text-xl font-extrabold text-n2f-accent mb-3">4. การแบ่งปันข้อมูล</h2>
            <p className="text-n2f-text-secondary leading-[1.8]">
          ...
          <section>
            <h2 className="text-xl font-extrabold text-n2f-accent mb-3">5. Cookie</h2>
            <p className="text-n2f-text-secondary leading-[1.8]">
          ...
          <section>
            <h2 className="text-xl font-extrabold text-n2f-accent mb-3">6. สิทธิ์ของคุณ</h2>
            <p className="text-n2f-text-secondary leading-[1.8]">
          ...
          <section>
            <h2 className="text-xl font-extrabold text-n2f-accent mb-3">7. การเปลี่ยนแปลง</h2>
            <p className="text-n2f-text-secondary leading-[1.8]">
          ...
          <section>
            <h2 className="text-xl font-extrabold text-n2f-accent mb-3">8. ติดต่อเรา</h2>
            <p className="text-n2f-text-secondary leading-[1.8]">
